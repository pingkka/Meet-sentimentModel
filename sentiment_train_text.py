...
def train():
    ...
    train_dataset = preprocessing_text.HwangariDataset("csv/result_sentiment_9100_train.csv")
    test_dataset = preprocessing_text.HwangariDataset("csv/result_sentiment_9100_test.csv")
