...
def train():
    ...
    train_dataset = preprocessing_text.HwangariDataset("csv/result_sentiment_9000_train_sur.csv")
    test_dataset = preprocessing_text.HwangariDataset("csv/result_sentiment_9000_test_sur.csv")
    ...
    model.save_pretrained("haremotions-v5")
