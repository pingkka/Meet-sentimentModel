...
def train():
    ...
    model3 = XGBClassifier(n_estimators=300, learning_rate=0.1, max_depth=7)
    ...
    # 파일명
    filename = 'audio_model/xgb_7_300_0.1_7_f.model'
    ...
    model3 = XGBClassifier(n_estimators=100, learning_rate=0.05, max_depth=6)
    model3.fit(X_train2, y_train2, eval_set=eval_s)
    model3.evals_result()
    score = cross_val_score(model3, X_train2, y_train2, cv=5)
    y_pred3 = model3.predict(X_test2)
    ...
    # 파일명
    filename = 'audio_model/xgb_7_100_0.1_6_f.model'
    ...
    model3 = XGBClassifier(n_estimators=400, learning_rate=0.1, max_depth=8)
    model3.fit(X_train2, y_train2, eval_set=eval_s)
    model3.evals_result()
    score = cross_val_score(model3, X_train2, y_train2, cv=5)
    y_pred3 = model3.predict(X_test2)
